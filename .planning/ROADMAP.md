...
Plans:
- [x] 01-01-PLAN.md - Fork upstream repository and configure settings
- [x] 01-02-PLAN.md - Create tap repository and initialize structure
- [x] 01-03-PLAN.md - Create PAT and configure repository secret (has checkpoint)
